...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody com.changlu.blogloom.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody com.changlu.blogloom.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(com.changlu.blogloom.model.dto.Blog blog, String type) {
		//验证普通字段
