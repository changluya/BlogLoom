package com.changlu.blogloom.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import com.changlu.blogloom.entity.ScheduleJobLog;
import com.changlu.blogloom.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.changlu.blogloom.entity.ScheduleJob scheduleJob = (com.changlu.blogloom.entity.ScheduleJob) context.getMergedJobDataMap().get(com.changlu.blogloom.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
