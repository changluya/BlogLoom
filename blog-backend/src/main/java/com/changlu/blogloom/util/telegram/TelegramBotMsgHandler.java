package com.changlu.blogloom.util.telegram;
...
import com.changlu.blogloom.config.properties.TelegramProperties;
...
import com.changlu.blogloom.util.comment.CommentUtils;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			com.changlu.blogloom.model.dto.Comment comment = new com.changlu.blogloom.model.dto.Comment();
