package com.changlu.blogloom.util.comment;
...
import com.changlu.blogloom.util.comment.channel.ChannelFactory;
import com.changlu.blogloom.util.comment.channel.CommentNotifyChannel;
import com.changlu.blogloom.enums.CommentOpenStateEnum;
import com.changlu.blogloom.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.changlu.blogloom.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.changlu.blogloom.entity.Comment parentComment, Comment comment) {
